        ...
        url: i, type: "get", dataType: "jsonp", success: function (e) {
            ...
            if (void 0 !== t) for (var l = !1, i = 0; i < t.length; i++) {
                ...
                if (!(o == s || IDs.indexOf(o + "") > -1)) {
                    ...
                    C = C.replace("s512", "s70"), C = z.match(/anonymous/i) ? "https://2.bp.blogspot.com/-GfFjD8etS2E/UTPve4mQdYI/AAAAAAAAC7k/gy0DVRlx4xM/s40/anonymous-Icon.jpg" : C.match(/(blank|rounded)(\.gif)/g) ? "https://2.bp.blogspot.com/-GfFjD8etS2E/UTPve4mQdYI/AAAAAAAAC7k/gy0DVRlx4xM/s40/anonymous-Icon.jpg" : C, html += "<li class='grid_6 element mfp-prevent-close'><div class='zenitem zenitem1  category full'><div class='zeninner mfp-prevent-close'><div class='column grid_twelve mfp-prevent-close'><div class='zencategory element1 firstitem mfp-prevent-close'><div class='sitelink mfp-prevent-close author_wrapper'><a class='mfp-prevent-close' href='/search/label/" + y + "?max-results=25#filters'><img class='mfp-prevent-close model_author_image' src='" + C + "'/><span class='model_author_title'>" + z + "</span></a></div></div><div class='zenimage element2'><span class='mfp-labels' style='display:none'>" + A + "</span><a class='jackbox' data-behavior='lightbox' data-group='gallery-334i' data-width='600' data-href='#" + o + "' expr:data-thumbTooltip='" + g + "' data-title='" + g + "'><img class='zoom_me' alt='" + g + "' data-mfp-comments='" + p + "' data-mfp-href='" + h + "' data-mfp-id='" + o + "' data-mfp-sitename='" + z + "' data-mfp-author='" + C + "' data-mfp-src='" + d + "' data-mfp-text='" + f + "' data-mfp-zentype='" + b + "' data-mfp-label='" + b + "' src='" + d + "' title='" + g + "'/></a></div><div class='zentitle element3'><strong><a class='jackbox' data-group='gallery-334t' data-width='600' data-href='" + h + "' data-title='" + g + "' href='" + h + "'><span>" + g + "</span></a></strong></div><div class='zentext element4 mfp-prevent-close'>" + f + "</div><a href='/search/label/" + y + "+" + b + "?max-results=25#filters' class='zentype mfp-prevent-close'>" + b + "</a><div class='zencomments mfp-prevent-close'><a class='zencomment_linkzero' href='" + h + "#comments'><span>" + p + "</span><i class='fa fa-comment fa-lg mfp-prevent-close'/></a></div></div><div class='clear'/></div></div></li>"
                }
            }
        }
    }).then(function () {
...
function getAuthorNameFromLabelPageUrl(label_page_url) {
    ...
    for (let i = 0; i < excludePostFixes.length; i++) {
        ...
        if (searchTerm.indexOf(postfix) !== -1 && searchTerm.endsWith(postfix)) {
            searchTerm = searchTerm.replace(postfix, '');
        }
    }
